...
import {UserTaskEvent} from "@/Components/Events/UserTaskEvent";
...
const renderContent = (notification) => {
    ...
    switch (notification.type) {
        ...
        case 'user_task': {
            return (<UserTaskEvent createdAt={createdAt} event={notification}/>);
        }
        case 'user_task1': {
            ...
            return (<>
                <ListItemAvatar sx={{mt: 0.5}}>
                    <Avatar src={notificationContent.avatar}>
                        <SvgIcon>
                            <User01Icon/>
                        </SvgIcon>
                    </Avatar>
                ...
                <ListItemText
                    primary={(<Box
                        sx={{
                            alignItems: 'center', display: 'flex', flexWrap: 'wrap', m: 0
                        }}
                    >
                        <Typography
                            sx={{mr: 0.5}}
...
export const NotificationsPopover = (props) => {
    const {
        anchorEl, notifications, onClose, onMarkAllAsRead, onRemoveOne, open = false, ...other
    } = props;
        ...
        {isEmpty ? (<Box sx={{p: 2}}>
            ...
            <List disablePadding>
                {notifications.map((notification) => (<ListItem
                    ...
                    secondaryAction={(<Tooltip title="Remove">
                        <IconButton
                            edge="end"
